...
fn runAllChecks() !void {
    ...
    //
    if (fails > 0) {
        std.log.info("FAILURES: {}", .{fails});
        return error.TestFailures;
    } else {
